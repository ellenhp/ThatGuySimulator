thatGuyGrammarDefinition = {
  ...
  "platform": ["iOS", "Android", "web", "Windows", "OS X", "Linux", "embedded"],
  "programmingTask": ["natural language processing", "deep learning", "scientific computing", "#platform# development"],
  "company": ["Google", "Apple", "Microsoft", "Intel", "Twitter", "Facebook"],
  "earlyAgeNumber": "6,7,8,9,10".split(","),
  "nonZeroDigit": "1,2,3,4,5,6,7,8,9".split(","),
